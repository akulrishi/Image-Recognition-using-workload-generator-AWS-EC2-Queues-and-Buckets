...
OUTPUT_QUEUE_NAME="OutputImageQueue"
AMI_ID='ami-04831fd52bc82cd8b'
SECURITY_GROUP_ID='sg-07185605e3ee5bc3f'
...
def create_apptier_instances(number):
    ...
    while i < number and current_instances <= 17:
        current_instances+=1
